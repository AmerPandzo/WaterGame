...
public class DataStorage
{
    ...
    public static void SaveToFile<T>(T dataToStore, StorageMethod method)
    {
        string fileName = SavingLocation + "." + method.ToString().ToLower();
    ...
    /// <param name="method">Storing method</param>
    /// <typeparam name="T">Typeof data to store</typeparam>
    public static T LoadFromFIle<T>(StorageMethod method)
    {
    ...
    public static void RemoveData()
    {
        ...
        {
            string fileName = SavingLocation + "." + ((StorageMethod)i).ToString().ToLower();
